...
import numpy
from plots import bounces_vs_path_num_k
...
def plot_bounces_vs_path_num_k(topo):
    """
    ...
    filename = os.path.join(figure_dir, f"plot_bounces_vs_path_num_k_{topo}_topo.pdf")
