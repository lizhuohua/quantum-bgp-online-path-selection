...
def plot_goodput_vs_measure_noise_vs_as_num():
    """
    ...
    file_path = os.path.join(output_dir, "plot_goodput_vs_measure_noise_vs_as_num.pickle")
    ...
    filename = os.path.join(figure_dir, "plot_goodput_vs_measure_noise_vs_as_num.pdf")
